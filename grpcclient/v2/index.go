...
func (c *Client) Chat(ctx context.Context, language languages.Language, currentMessage *structs.PromptMessage, historyMessages []*structs.PromptMessage) (string, error) {
